...
public class BasicConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
            ...
            .requestMatchers("/api/cycle/register","/api/cycle/post/register", "/api/auth/token", "/api/cycle/list", "/api/cycle/add", "/api/cycle/{id}/restock", "/api/cycle/{id}/return").permitAll()
           //, "/api/cycle/{id}/borrow"
